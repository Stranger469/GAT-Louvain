...
class MinibatchIterator(object):
    ...
    def __init__(self, 
        ...
        if self.training:
            ...
            self.calculate_session_ids = self._remove_infoless(self.all_data, self.test_adj, self.test_deg)
    ...
    def user_visible_time(self):
        ...
        print('end processing visible time')
        return visible_time
    ...
    def _padding_sessions(self, data):
        ...
        data_mask = {}
        missed_count = 0
        with open('missed_session.csv', 'w') as f:
    ...
    def _batch_feed_dict(self, current_batch):
        ...
        # print(support_layers_length)
        # print(support_layers_session)
    ...
    def next_val_minibatch_feed_dict(self, val_or_test='val'):
        ...
        # ------------------------------------------------
        elif val_or_test == 'calculate':
            start = self.batch_num_calculate * self.batch_size
            self.batch_num_calculate += 1
            data = self.calculate_session_ids
        # ------------------------------------------------
        else:
        ...
        # ——————————————————————————————————————————————————————————————————————————————————————————
        self.nodes = nodes = [int(sessionid.split('_')[0]) for sessionid in current_batch_sessions]
        #———————————————————————————————————————————————————————————————————————————————————————————
    ...
    def next_train_minibatch_feed_dict(self):
        ...
        # print('current_batch_sessions: ', current_batch_sessions)
    ...
    def end_val(self, val_or_test='val'):
        ...
        if val_or_test == 'val':
            ...
            batch_num = self.batch_num_calculate
            data = self.calculate_session_ids
        # ------------------------------------------------
        ...
        if end:
            if val_or_test == 'val':
                self.batch_num_val = 0
            elif val_or_test == 'test' or val_or_test == 'calculate':
                self.batch_num_test = 0
            else:
                raise NotImplementedError
...
if __name__ == '__main__':
    ...
    # print('0_48: ', minibatch.padded_data['0_48'])
    # print('0_48_mask: ', minibatch.mask['0_48'])
    # print('0_131: ', minibatch.padded_data['0_131'])
    # print('0_131_mask: ', minibatch.mask['0_131'])
    # print('construct_adj: ', minibatch.adj, minibatch.deg)
    # minibatch.next_train_minibatch_feed_dict()
